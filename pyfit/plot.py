...
def plot_planar_data(X: np.ndarray, y: np.ndarray) -> None:
...
def plot_decision_boundary(
    pred_func: Any, X: np.ndarray, y: np.ndarray, figure: Any = None
) -> None:
...
def plot_multiclass(X: np.ndarray, y: np.ndarray) -> None:
...
def plot_multiclass_decision_boundary(pred_func: Any, X: np.ndarray, y: np.ndarray) -> None:
